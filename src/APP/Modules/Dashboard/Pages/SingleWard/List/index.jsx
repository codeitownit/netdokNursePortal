      ...
      >
        ...
        <Tbody>
          {Array.from(addedPatients.values())
            ...
            .map((doc, index) => {
                if(doc?.admittingUnit === id){
                    console.log(doc)
                }
              console.log(doc.admittingUnit);
              if((doc?.admStatus === "admitted" || doc?.admStatus === "observation") && doc?.admittingUnit === id){
              return (
                <Rows
