...
import PermissionBox from "./sections/PermissionBox";
import SinglePermissionArea from "./sections/SinglePermissionArea";
      ...
      <div className="mt-4 flex justify-center">
        <Button
          ...
          style={{
            color: "white",
            fontFamily: "Impact",
            border: `3px solid ${hovered ? "#EEAD49" : "#0E2F59"}`,
            backgroundColor: `${hovered ? "#0E2F59" : "#EEAD49"}`,
            padding: "5px 7px",
            borderRadius: "10px",
            fontSize: "20px",
          }}
