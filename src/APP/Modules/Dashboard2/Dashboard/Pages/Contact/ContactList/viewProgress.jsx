...
function ViewProgressJournal({ text = "Edit Journal" }) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (res !== "error") {
        ...
        setProgressReport(res?.data.progressReport);
  ...
  return (
    <div className={grayPanel()}>
      ...
      <TextArea
        ...
        directInput={true}
        required={false}
        stateInput={progressReport}
        setStateInput={setProgressReport}
        disabled={true}
      />
      <TextArea
        label="Symptoms"
...
export default ViewProgressJournal;
